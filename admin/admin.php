...
//delete_option('lj_logo');
	...
	global $themename, $shortname, $options;
		...
		add_theme_page('Page title', $themename.' Settings', 10, $shortname, 'lj_header');
...
<p>Thanks for downloading <strong><a href="http://linesh.com/projects/graphi/"><?php echo $themename; ?></a></strong> by Linesh Jose. Hope you enjoy using it!</p>
    ...
    <tr>
      <td width="80%" valign="top"><div id="poststuff" class="">
          <div class="stuffbox">
            ...
            <div class="inside">
              <?php lj_dashboard_widget_function();?>
            </div>
          </div>
        </div>
